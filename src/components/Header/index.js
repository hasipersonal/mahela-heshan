                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-10">
                            <div className="logo">
                                {/* <h2><Link to='/home'>Mahela<span><i className="fa fa-heart" aria-hidden="true"></i></span>Nelum</Link></h2> */}
                                <h2><Link to='/home'>Mahela<span><img className='heart-icon' src="../heart-icon.png" alt="Heart Icon" /></span>Nelum</Link></h2>
                            </div>
                        </div>
